...
const uint16_t PROGMEM fm_combo[] = {S(KC_F), S(KC_M), COMBO_END};
const uint16_t PROGMEM fp_combo[] = {S(KC_F), S(KC_P), COMBO_END};
const uint16_t PROGMEM cl_combo[] = {S(KC_C), S(KC_L), COMBO_END};
...
combo_t key_combos[] = {
  ...
  [FM_UPPER_V] = COMBO(fm_combo, S(KC_V)),
  [FP_UPPER_Q] = COMBO(fp_combo, S(KC_Q)),
  [CL_UPPER_Z] = COMBO(cl_combo, S(KC_Z)),
